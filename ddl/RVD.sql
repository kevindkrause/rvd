...
create table dbo.Cong(
	...
	Midweek_Meeting_DOW			nvarchar(100),
	Midweek_Meeting_Time		nvarchar(100),
	Weekend_Meeting_DOW			nvarchar(100),
	Weekend_Meeting_Time		nvarchar(100),	
...
if object_id('dbo.PRP_Actuals_Level_02_snp', 'U') is not null
	drop table dbo.PRP_Actuals_Level_02_snp
go 
create table dbo.PRP_Actuals_Level_02_snp(
	cpc_code 			nvarchar(10) not null,
	wk_01_dt 			date,
	wk_01_budget 		int,
	wk_01_used 			int,
	...
	wk_26_used 			int,
	wk_26_avail 		int,
	load_date 			datetime not null constraint df_prp_actuals_02_load_date default getdate()
) 
go


if object_id('dbo.PRP_Actuals_Level_03_snp', 'U') is not null
	drop table dbo.PRP_Actuals_Level_03_snp
go 
create table dbo.PRP_Actuals_Level_03_snp(
	cpc_code 			nvarchar(10) not null,
	level_03 			nvarchar(100),
	wk_01_dt 			date,
	wk_01_budget 		int,
	...
	wk_26_used 			int,
	wk_26_avail 		int,
	load_date 			datetime not null constraint df_prp_actuals_03_load_date default getdate()
) 
go


if object_id('dbo.PRP_Actuals_Level_04_snp', 'U') is not null
	drop table dbo.PRP_Actuals_Level_04_snp
go 
create table dbo.PRP_Actuals_Level_04_snp(
	cpc_code 			nvarchar(10) not null,
	level_03 			nvarchar(100),
	level_04 			nvarchar(100),
	wk_01_dt 			date,
	...
	wk_26_used 			int,
	wk_26_avail 		int,
	load_date 			datetime not null constraint df_prp_actuals_04_load_date default getdate()
) 
go
